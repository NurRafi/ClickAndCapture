            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                ...
                <ul>
                    ...
                    <li><span class="glyphicon glyphicon-phone"></span> <a href="#"
                                                                           title="call"><?php echo $phone ?></a></li>
                    <li><span class="glyphicon glyphicon-euro"></span> <a href="#"
                                                                          title="price"><?php echo $price ?></a></li>
                    <li><span class="glyphicon glyphicon-envelope"></span><a href="#"
                                                                             title="mail"><?php echo $email ?></a></li>
                </ul>
            </div>
        </div>
        <!--profile-head close-->
            ...
            <div class="row align-items-stretch">
                ...
                foreach ($table as $row) {
                    ...
                    <div class="col-6 col-md-6 col-lg-8" data-aos="fade-up">
                        <a href="order.php?project=<?php echo $row['project_name'] ?>&user_email=<?php echo $user_email ?>"
